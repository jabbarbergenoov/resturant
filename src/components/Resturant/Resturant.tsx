...
export function Resturant() {
  ...
  const menu = [
    { category: "Pizzas", items: [{ name: "Margherita", description: "Classic tomato and cheese", price: "$12.99" }, { name: "Pepperoni", description: "Pepperoni and mozzarella", price: "$14.99" }] },
    { category: "Pasta", items: [{ name: "Carbonara", description: "Creamy sauce with bacon", price: "$11.99" }, { name: "Pesto", description: "Basil and parmesan sauce", price: "$10.99" }] },
    { category: "Burgers", items: [{ name: "Cheeseburger", description: "Beef patty with cheese", price: "$9.99" }, { name: "Veggie Burger", description: "Grilled vegetables and hummus", price: "$8.99" }] },
    { category: "Каляны", items: [{ name: "Kalian", description: "Beef patty with cheese", price: "$9.99" }, { name: "Vegfdgfdgfdg", description: "Grilled vegetables and hummus", price: "$8.99" }] },
    { category: "Siger", items: [{ name: "Siger", description: "Beef patty with cheese", price: "$9.99" }, { name: "fdgfdg", description: "Grilled vegetables and hummus", price: "$8.99" }] },
    { category: "Drinks", items: [{ name: "Coca Cola", description: "Cold refreshing drink", price: "$3.99" }, { name: "Orange Juice", description: "Fresh orange juice", price: "$4.99" }] },
    { category: "Desserts", items: [{ name: "Chocolate Cake", description: "Rich chocolate cake", price: "$6.99" }, { name: "Ice Cream", description: "Vanilla ice cream", price: "$5.99" }] },
  ];
  ...
  return (
    <div className="min-h-[0vh] bg-gray-100 dark:bg-gray-900">
      ...
      <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Меню</h1>
  ...
  <DropdownMenuContent className="w-56">
    ...
    <DropdownMenuGroup>
      <DropdownMenuSub>
        ...
        {menu.slice(Number(visibleCategories), visibleCategories).map((category, index) => (
  <button
    key={index}
    ...
    {category.category}
        ...
        <div className="mb-6">
          {visibleCategories < menu.length ? (
            <button
              onClick={() => setVisibleCategories((prev) => Math.min(prev + 3, menu.length))}
